...
独立後はGCP、AWSによるアーキ設計、検証、インフラ構築、バックエンドの開発PJに関わる。
...
- 業務内容
    - GCP Anthosを用いたKubernetesクラスタのマルチクラスタ化プロジェクトの推進

- 実績・取り組みなど
    - 国内にほぼ情報のないGCP Anthosに関して先んじて調査を行い、知見化しアウトプットを行った
    - 技術調査、検証、実装、テスト、リリースまで一貫して主導
  
- 関連アウトプット
  - [技術ブログ](https://taisho6339.hatenablog.com/archive/2020)
  - [Kubernetesネットワーク 徹底解説](https://zenn.dev/taisho6339/books/fc6facfb640d242dc7ec)
  - [登壇資料](https://speakerdeck.com/taisho6339)
...
- 使用技術
    - Java/J2EE, Golang, gRPC, GKE, Elastic Beanstalk, RDS(MySQL), CircleCI, Ansible, Terraform,
      Datadog
...
新卒入社。 主にY!乗換案内Androidアプリの開発を担当。 アプリリニューアルプロジェクトのコアメンバーとして、
